...
# Load data
work_dir = "F:/CIAT/Interdependence/production_data"
main_data_set <- read.csv(paste(work_dir, "/outputs_merged/prod_2009-2011_mean_final_mc_fm_selcom_selcoun.csv", sep=""), header=T)
...
write.csv(summary_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_summary_db.csv", sep=""), row.names=F)
...
write.csv(test1, paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/prod_countries_regions_all_merge.csv",sep=""), row.names=F)
...
write.csv(test3, paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/prod_countries_regions_dupregionscrops.csv",sep=""), row.names=F)
...
write.csv(dependence_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_native.csv", sep=""), row.names=F)

## Read db summary
summary_results <- read.csv(paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_summary_db.csv", sep=""))
country <- sort(as.character(unique(summary_results$Country)))

## Read maximum dependence data
dependence_results <- read.csv(paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_native.csv", sep=""))
...
write.csv(max_dependence_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Maximum_dependence.csv", sep=""), row.names=F)

# Calculate contribution of all commodities where region = "Not_Specified"

test2 <- read.csv(paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/prod_countries_regions_all_merge.csv",sep=""), header=T)

test4 <- test2[test2$Region_crops=="Not_Specified",]
rownames(test4) <- 1:nrow(test4)
write.csv(test4, paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/prod_countries_notspecified.csv",sep=""), row.names=F)
...
write.csv(nspecified_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_nspecified.csv", sep=""), row.names=F)

# Read Not specified data

nspecified_results <- read.csv(paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Total_nspecified.csv", sep=""))
...
write.csv(percent_nspecified_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Nspecified_percent.csv", sep=""), row.names=F)
...
percent_nspecified_results <- read.csv(paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Nspecified_percent.csv", sep=""))
...
write.csv(min_dependence_results[[1]], paste("F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/Minimum_dependence.csv", sep=""), row.names=F)

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# Put maximum and minimum together
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#

dep_dir <- "F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence"
...
write.csv(combined, "F:/CIAT/Interdependence/scripts/interdependence_prod_bayesian/production_data/by_production_value/results_dependence/combined_dependence_area.csv", row.names=F)
...
write.csv(dep_files_merged, paste("F:/CIAT/Interdependence/production_data/results_dependence/combined_dependence_regions.csv", sep=""), row.names=F)
...
write.csv(dep_files_merged, paste("F:/CIAT/Interdependence/production_data/results_dependence/combined_dependence_regions_final.csv", sep=""), row.names=F)

dep_files_merged <- read.csv(paste("F:/CIAT/Interdependence/production_data/results_dependence/combined_dependence_regions_final.csv", sep=""))
...
p <- p + xlab("") + ylab("Percent dependence (%)") + ggtitle("Percent of gross production value of nationally produced food crops\nsourcing from crops of non-native regions of primary diversity")
...
p <- p + labs(fill="")
p
ggsave(filename=paste("F:/CIAT/Interdependence/figures/production/production_dependence_by_countries.pdf", sep=""), plot=p, width=6, height=4)
